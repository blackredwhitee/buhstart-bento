...
<?php elseif ($page === 'prices'):
  ...
  $LABEL = [
    ...
    'entity_ooo' => 'Надбавка за ООО', 'optima_base' => 'Оптима: управленческий учёт (доплата к Стандарту)',
    'visit_price' => 'Один визит бухгалтера в офис', 'ved' => 'ВЭД и валютные расчёты',
    'reconcile' => 'Сверки с контрагентами', 'tax_mgmt' => 'Налоговый менеджмент',
    'military_per' => 'Воинский учёт, за сотрудника', 'licenses' => 'Лицензионная отчётность, за лицензию',
    'tax' => 'Система налогообложения', 'vat' => 'НДС', 'niche' => 'Вид деятельности',
    'staff' => 'Сотрудники', 'cash' => 'Наличные расчёты', 'invoice' => 'Ведение расчётного счёта',
  ];
  $NAME = [
  ...
  <p class="lead">Стоимость в рублях за месяц — себестоимость, без наценки.
     Клиенту калькулятор показывает на 25% больше: 20 000 превращаются в 25 000.
     Исключение — «Ведение расчётного счёта»: там цены уже конечные.
     Цифры подхватываются сразу, пересобирать ничего не нужно.</p>
  <form class="panel" method="post">
