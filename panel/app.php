...
<?php elseif ($page === 'prices'):
  ...
  <p class="lead">Цены в рублях за месяц — ровно те, что видит клиент, как в прайсе
     в столбце «Клиент». Ничего не пересчитывается: что впишете, то и покажет калькулятор.
